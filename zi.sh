#!/bin/bash
# dev UDP Module installer
# Creator Al-amin Sarker
...
wget https://raw.githubusercontent.com/Nortondb12/unnemv/main/config.json -O /etc/zivpn/config.json 1> /dev/null 2> /dev/null
